...
use xen_theory::dataset::{default_chords, default_notation_systems, default_scales, default_temperaments, default_tunings};
...
impl AppState {
    ...
    pub fn update_temperament(&mut self, idx: usize, name: String, divisions: u32, period: (u32, u32)) {
    ...
    pub fn delete_temperament(&mut self, idx: usize) {
        ...
        self.notation_systems.retain(|ns| ns.temperament_name != name);
        self.tunings.retain(|tu| tu.temperament_name != name);
